...
public class IbmFace extends WatsonService {

    private static final String SERVICE_NAME = "Visual Recognition-ud\n";
     ...
     */
    public IbmFace(String versionDate) {
        super(SERVICE_NAME);
     ...
     */
    public IbmFace (String versionDate, String apiKey) {
        this(versionDate);
        setApiKey(apiKey);
    }
