...
public class MethodMain {
    ...
    /**
     * Méthode permettant d'uploader une listePhoto de vidéos et d'attendre que l'API de microsoft ait terminé de les indexer
    ...
    {
        //videoId est la listePhoto qui va contenir la listePhoto des Id des vidéos que videoIndexer va renvoyer
        List <String> videoIds = new ArrayList<>();
        System.out.println("videos en cours d'upload");
        //On rajoute dans la listePhoto le retour de l'upload de videoIndexer
     ...
     * @param pathVideos La listePhoto des chemins pour accéder aux vidéos (pour en extraire le nom)
     */
    ...
    /**
     * Méthode permettant de prendre chaque photo de profil, la comparer avec chaque listePhoto de photo de profil extraite des vidéos,
    ...
    public static JSONObject detectFaceWithVideoAndPhoto (List <String> photosPath, int nbVideos, List <String> videosPath)
    {
        ...
        //L'objet qui va contenir le résultat avec microsoft comme key et la listePhoto des photos et vidéos en parametre
