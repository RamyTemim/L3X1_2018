...
public class MicrosoftCodeVideo
{
    public static void main(String[] args)
    {
        ...
        try
        {
            URIBuilder builder = new URIBuilder("https://videobreakdown.azure-api.net/Breakdowns/Api/Partner/Breakdowns?name={name}&privacy={privacy}");

            builder.setParameter("videoUrl", "{string}");
